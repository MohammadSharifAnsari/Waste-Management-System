...
import { postArticles,getAllArticles, deleteArticle,updateArticle, PostComment} from "../controller/article.controller.js";
...
router.route('/comment').post(isloggedin, PostComment )
