...
const userSchema=new mongoose.Schema({
    ...
    //yeh user ka avatar hai jiske liye cloudinary service use karenge baad me acche se baat karnge ispar
    avatar:{
...
export default mongoose.model("user",userSchema);//database me user->users ho jaega
